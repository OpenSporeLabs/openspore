...
extern "C" void W6_THISCALL app_system_initialize_plugins_007e93d0(
  ...
  ports.append_00423650(&registration->first_command_line_copy_138,
                        command_line, end);
  ports.append_004f6510(&registration->first_command_line_copy_138, 0x005cU);
  end = wide_string_end(second_command_line);
  ports.append_00423650(&registration->second_command_line_copy_148,
                        second_command_line, end);
