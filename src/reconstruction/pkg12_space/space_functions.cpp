...
extern "C" Opaque __fastcall pkg12_re_00ce6950(Opaque manager);
extern "C" void __thiscall pkg12_re_00aeb720(Opaque manager, Opaque space,
                                             Opaque event_data, Opaque value_2,
                                             Opaque event_code, Opaque value_4,
                                             Opaque value_5);
