...
extern void* __thiscall raw_manager_lookup(void*, std::uint32_t, std::uint32_t);

extern std::uint8_t __thiscall raw_manager_set_state(void*, std::uint32_t);

extern std::uint8_t __thiscall raw_manager_apply_state(void*, void*,
                                                       std::uint32_t,
                                                       std::uint32_t);
  ...
  switch (mode) {
    ...
    case 2:
      dispatch_target_slot(field_at<OpaqueEditorModeTarget*>(manager, 0x64), 1,
                           0);
      dispatch_target_slot(
          editor_mode_manager_lookup_target(manager, 0x578ec50u), 1, 0);
      dispatch_target_slot(
...
void __thiscall editor_mode_manager_set_active_mode(
    OpaqueEditorModeManager* manager, std::uint32_t mode) {
