...
using namespace openspore::reconstruction::pkg_palette_safe_wave11;

int g_failures = 0;
int g_checks = 0;

// assert() compiles away under -DNDEBUG, which would leave the two NDEBUG
// configurations verifying nothing, so every assertion goes through this
// counter and main() reports a real failure path instead of returning zero
// unconditionally.
...
void PKG_PALETTE_SAFE_WAVE11_THISCALL stub_node_slot01(OpaqueNode* node) {
  static_cast<void>(node);
  ++g_node_slot01_calls;
}

void PKG_PALETTE_SAFE_WAVE11_THISCALL stub_node_slot02(OpaqueNode* node) {
  static_cast<void>(node);
  ++g_node_slot02_calls;
}
void PKG_PALETTE_SAFE_WAVE11_THISCALL
stub_list_slot01(OpaquePropertyList* list) {
  static_cast<void>(list);
  ++g_list_slot01_calls;
}

bool PKG_PALETTE_SAFE_WAVE11_THISCALL stub_list_slot09(OpaquePropertyList* list,
                                                       std::uint32_t key,
                                                       OpaqueProperty** out) {
  static_cast<void>(list);
...
OpaquePropertyList* PKG_PALETTE_SAFE_WAVE11_THISCALL
...
void PKG_PALETTE_SAFE_WAVE11_THISCALL stub_mode_slot31(
    OpaqueGameModeManager* manager, void* context, OpaqueTextBuffer* buffer) {
...
void PKG_PALETTE_SAFE_WAVE11_THISCALL stub_lead_slot01(OpaquePageLead* lead) {
  static_cast<void>(lead);
  ++g_lead_slot01_calls;
}

void PKG_PALETTE_SAFE_WAVE11_THISCALL stub_lead_slot66(OpaquePageLead* lead,
                                                       void* payload) {
  static_cast<void>(lead);
...
OpaqueLink* PKG_PALETTE_SAFE_WAVE11_THISCALL
unresolved_005c9830(OpaqueLink* self) {
...
void* PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_00401020() {
  ++g_manager_getter_calls;
  return g_swatch_self;
}

void PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005f0a60(void* self,
                                                          void* arg) {
  ++g_swatch_calls;
  g_swatch_self = self;
  g_swatch_arg = arg;
...
OpaqueCategoryList* PKG_PALETTE_SAFE_WAVE11_THISCALL
...
OpaquePageList* PKG_PALETTE_SAFE_WAVE11_THISCALL
...
OpaqueEntryList* PKG_PALETTE_SAFE_WAVE11_THISCALL
...
OpaquePropertyList* PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_0067de30() {
  return g_list_table;
}

OpaqueGameModeManager* PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_0067dcd0() {
  return g_mode_instance;
}

bool PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a12a0(OpaquePropertyList* list,
                                                       std::uint32_t key,
                                                       std::uint32_t* out) {
  static_cast<void>(list);
  ++g_probe_a12a0_calls;
...
bool PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a07d0(OpaquePropertyList* list,
                                                       std::uint32_t key,
                                                       std::uint32_t* count,
                                                       std::uint32_t** array) {
...
bool PKG_PALETTE_SAFE_WAVE11_CDECL
unresolved_006a0ae0(OpaquePropertyList* list, std::uint32_t key,
                    std::uint32_t* count, OpaqueResourceKey* info) {
  static_cast<void>(list);
  static_cast<void>(key);
  ++g_probe_a0ae0_calls;
...
bool PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a1160(OpaquePropertyList* list,
                                                       std::uint32_t key,
                                                       OpaqueFloat4* out) {
  static_cast<void>(list);
  static_cast<void>(key);
...
void PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a1250(OpaquePropertyList* list,
                                                       std::uint32_t key,
...
void PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_00410370(OpaquePropertyList* list,
                                                       std::uint32_t key,
                                                       std::uint32_t* out) {
  static_cast<void>(list);
  ++g_prop_410370_calls;
...
void PKG_PALETTE_SAFE_WAVE11_CDECL
unresolved_00933960(OpaqueTextBuffer* buffer) {
...
void PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_00f47380(void* block) {
  ++g_free_f47380_calls;
...
OpaqueNode* PKG_PALETTE_SAFE_WAVE11_THISCALL
unresolved_005c66a0(OpaqueNode* self) {
  ++g_node_ctor_calls;
  self->vtable = g_node_table->vtable;
  return self;
}

bool PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005c6810(
    OpaqueNode* self, void* source, std::uint32_t threshold, void* extra) {
...
void* PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005766e0(void* slot_ptr,
                                                           OpaqueNode* value) {
  ++g_assign_calls;
...
void PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005c8480(OpaqueNode** base,
                                                          OpaqueNode** cursor,
                                                          OpaqueNode** slot) {
...
const std::uint8_t* PKG_PALETTE_SAFE_WAVE11_THISCALL
unresolved_0041e920(OpaqueProperty* self) {
  return self == &g_property ? &g_property_byte : nullptr;
}

const std::uint32_t* PKG_PALETTE_SAFE_WAVE11_THISCALL
...
const float* PKG_PALETTE_SAFE_WAVE11_THISCALL
...
void test_resolve_link_tail() {
  ...
  g_call_1 = palette_safe_wave11_resolve_link_tail_005c2e00(&first);
  assert(g_call_1 == 0U);

  first.field6c = &first_inner;
  g_link_calls = 0;
  g_link_at = 0;
  g_call_2 = palette_safe_wave11_resolve_link_tail_005c2e00(&first);
  ...
  g_link_calls = 0;
  g_link_at = 0;
  g_call_3 = palette_safe_wave11_resolve_link_tail_005c2e00(&first);
  ...
  g_link_calls = 0;
  g_link_at = 0;
  g_call_4 = palette_safe_wave11_resolve_link_tail_005c2e00(&first);
  ...
  g_link_calls = 0;
  g_link_at = 0;
  g_call_5 = palette_safe_wave11_resolve_link_tail_005c2e00(&first);
  ...
  g_link_calls = 0;
  g_link_at = 0;
  g_call_6 = palette_safe_wave11_resolve_link_tail_005c2e00(&first);
  assert(g_call_6 == 0U);
  ...
  g_link_calls = 0;
  g_link_at = 0;
  g_call_7 = palette_safe_wave11_resolve_link_tail_005c2e00(&first);
...
void test_release_page_hold() {
  ...
  palette_safe_wave11_release_page_hold_005c7320(&host);
...
void test_walk_has_leaf() {
  ...
  walk.field18 = 0;
  walk.field1c = 0;
  g_call_8 = palette_safe_wave11_walk_has_leaf_005c7c10(&walk);
  assert(!g_call_8);
  ...
  g_call_9 = palette_safe_wave11_walk_has_leaf_005c7c10(&walk);
  assert(!g_call_9);
  assert(g_root_calls == 1);
  assert(g_category_calls == 1);
  ...
  g_call_10 = palette_safe_wave11_walk_has_leaf_005c7c10(&walk);
  assert(g_call_10);
  assert(g_root_calls == 1);
  ...
  g_call_11 = palette_safe_wave11_walk_has_leaf_005c7c10(&walk);
  assert(!g_call_11);
  assert(g_root_calls == 1);
  assert(g_category_calls == 0);
  assert(g_entry_calls == 1);
...
void test_fill_node_array() {
  ...
  palette_safe_wave11_fill_node_array_005c7ff0(&build, &expected, &context,
                                               nullptr);
...
void test_load_page_state() {
  ...
  g_call_12 = palette_safe_wave11_load_page_state_005c85d0(&build, &probe_slot,
                                                           hold_slot);
  assert(g_call_12);
  assert(g_list_slot11_calls == 1);
  assert(g_open_a == 0U);
  ...
  build.field74 = grid;
  build.field78 = &grid[4];
  g_call_13 = palette_safe_wave11_load_page_state_005c85d0(&build, &probe_slot,
                                                           hold_slot);
  assert(g_call_13);
  ...
  build.field78 = &grid[4];
  g_call_14 = palette_safe_wave11_load_page_state_005c85d0(&build, &probe_slot,
                                                           hold_slot);
  assert(g_call_14);
  ...
  g_call_15 = palette_safe_wave11_load_page_state_005c85d0(&build, &probe_slot,
                                                           hold_slot);
  assert(g_call_15);
  assert(build.field48.bytes.byte48 == 0x5aU);
  assert(build.field48.bytes.byte49 == 0x5aU);
  ...
  g_opened_list = nullptr;
  reset_counters();
  g_call_16 = palette_safe_wave11_load_page_state_005c85d0(&build, &probe_slot,
                                                           hold_slot);
  assert(!g_call_16);
  assert(g_list_slot01_calls == 0);
  ...
  g_property_tag = 0x0dU;
  g_probe_a1160_value.field00 = 1.0F;
  g_call_17 = palette_safe_wave11_load_page_state_005c85d0(&build, &probe_slot,
                                                           hold_slot);
  assert(g_call_17);
  assert(g_probe_a12a0_calls == 0);
  assert(build.field0c == reinterpret_cast<std::uint32_t>(hold_slot));
...
int main() {
  ...
  std::printf("pkg-palette-safe-wave11 model: checks=%d failures=%d\n",
              g_checks, g_failures);
