...
#error "PKG-PALETTE-SAFE-WAVE11 requires an x86-32 target"
#endif

static_assert(sizeof(void*) == 4,
              "PKG-PALETTE-SAFE-WAVE11 target pointers are 32-bit");
static_assert(sizeof(std::uint32_t) == 4,
              "PKG-PALETTE-SAFE-WAVE11 target words are 32-bit");
static_assert(sizeof(std::uint16_t) == 2,
              "PKG-PALETTE-SAFE-WAVE11 target text units are 16-bit");

#if defined(_MSC_VER)
#define PKG_PALETTE_SAFE_WAVE11_THISCALL __thiscall
#define PKG_PALETTE_SAFE_WAVE11_CDECL __cdecl
#else
#define PKG_PALETTE_SAFE_WAVE11_THISCALL __attribute__((thiscall))
#define PKG_PALETTE_SAFE_WAVE11_CDECL __attribute__((cdecl))
#endif
...
using ReleaseSlot01 PKG_PALETTE_SAFE_WAVE11_THISCALL = void (*)(void*);
using DropSlot02 PKG_PALETTE_SAFE_WAVE11_THISCALL = void (*)(void*);
using ListSlot04 PKG_PALETTE_SAFE_WAVE11_THISCALL =
    void (*)(OpaquePropertyList*);
using ListSlot24 PKG_PALETTE_SAFE_WAVE11_THISCALL =
    bool (*)(OpaquePropertyList*, std::uint32_t, OpaqueProperty**);
using ListSlot2c PKG_PALETTE_SAFE_WAVE11_THISCALL =
    OpaquePropertyList* (*)(OpaquePropertyList*, std::uint32_t, std::uint32_t,
                            OpaquePropertyList**);
using PageSlot108 PKG_PALETTE_SAFE_WAVE11_THISCALL = void (*)(OpaquePageLead*,
                                                              void*);
using ModeSlot7c PKG_PALETTE_SAFE_WAVE11_THISCALL =
    void (*)(OpaqueGameModeManager*, void*, OpaqueTextBuffer*);

extern "C" {

std::uint32_t PKG_PALETTE_SAFE_WAVE11_THISCALL
palette_safe_wave11_resolve_link_tail_005c2e00(OpaqueLink*);
void PKG_PALETTE_SAFE_WAVE11_THISCALL
palette_safe_wave11_release_page_hold_005c7320(OpaquePageHost*);
bool PKG_PALETTE_SAFE_WAVE11_THISCALL
palette_safe_wave11_walk_has_leaf_005c7c10(OpaqueWalkIndex*);
void PKG_PALETTE_SAFE_WAVE11_THISCALL
palette_safe_wave11_fill_node_array_005c7ff0(OpaquePageBuild*,
                                             const std::uint32_t*, void*,
                                             void*);
bool PKG_PALETTE_SAFE_WAVE11_THISCALL
palette_safe_wave11_load_page_state_005c85d0(OpaquePageBuild*, OpaqueProperty**,
                                             OpaqueProperty**);

OpaqueLink* PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005c9830(OpaqueLink*);
void* PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_00401020();
void PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005f0a60(void*, void*);
...
unresolved_005c1ce0(void*, std::int32_t);
...
bool PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a12a0(OpaquePropertyList*,
                                                       std::uint32_t,
                                                       std::uint32_t*);
bool PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a07d0(OpaquePropertyList*,
                                                       std::uint32_t,
                                                       std::uint32_t*,
                                                       std::uint32_t**);
bool PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a0ae0(OpaquePropertyList*,
                                                       std::uint32_t,
                                                       std::uint32_t*,
                                                       OpaqueResourceKey*);
bool PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a1160(OpaquePropertyList*,
                                                       std::uint32_t,
                                                       OpaqueFloat4*);
void PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_006a1250(OpaquePropertyList*,
                                                       std::uint32_t,
                                                       OpaqueResourceKey*);
void PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_00410370(OpaquePropertyList*,
                                                       std::uint32_t,
                                                       std::uint32_t*);
void PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_00933960(OpaqueTextBuffer*);
void PKG_PALETTE_SAFE_WAVE11_CDECL unresolved_00f47380(void*);
void* PKG_PALETTE_SAFE_WAVE11_CDECL
unresolved_00f473a0(std::uint32_t, std::uint32_t, std::uint32_t, std::uint32_t,
                    std::uint32_t, std::uint32_t);

OpaqueNode* PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005c66a0(OpaqueNode*);
bool PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005c6810(OpaqueNode*, void*,
                                                          std::uint32_t, void*);
void* PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005766e0(void*, OpaqueNode*);
void PKG_PALETTE_SAFE_WAVE11_THISCALL unresolved_005c8480(OpaqueNode**,
                                                          OpaqueNode**,
                                                          OpaqueNode**);
...
unresolved_0041ea70(OpaqueProperty*);
