...
using OpaquePropertyResolver =
    OpaqueProperty*(PKG20_WAVE6_THISCALL*)(OpaquePropertyService*, TargetWord);
using OpaqueListSetProperty = void(PKG20_WAVE6_THISCALL*)(OpaqueList*,
                                                          TargetWord,
                                                          OpaqueProperty*);
using OpaqueListGetProperty =
    OpaqueProperty*(PKG20_WAVE6_THISCALL*)(OpaqueList*, TargetWord);
using OpaqueBaseHasProperty = bool(PKG20_WAVE6_THISCALL*)(OpaqueBaseObject*,
                                                          TargetWord);
...
using OpaqueBaseInsert = void(PKG20_WAVE6_THISCALL*)(OpaqueList*, TargetWord,
                                                     OpaqueProperty*);
...
static_assert(offsetof(OpaqueMap, field_04) == 0x04, "opaque map end offset");
static_assert(offsetof(OpaqueMap, field_14) == 0x14, "opaque map mode offset");
...
static_assert(offsetof(OpaqueList, field_18) == 0x18, "opaque list map offset");
...
bool PKG20_WAVE6_THISCALL
opaque_list_has_property_006a27d0(OpaqueList* list, TargetWord property_id);
