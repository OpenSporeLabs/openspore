...
using RetainSlot = void(PKG_SPOREPEDIA_SAFE_WAVE10_THISCALL*)(OpaqueAssetRef*);
using ReleaseSlot = void(PKG_SPOREPEDIA_SAFE_WAVE10_THISCALL*)(OpaqueAssetRef*);
...
using KeyFillPort = OpaqueKey16*(
    PKG_SPOREPEDIA_SAFE_WAVE10_THISCALL*)(OpaqueKeyedSet*, OpaqueKey16*, Word);
using MaskTestPort =
    std::uint8_t(PKG_SPOREPEDIA_SAFE_WAVE10_CDECL*)(OpaqueKey16, OpaqueKey16);
using KeyCollectPort =
    bool(PKG_SPOREPEDIA_SAFE_WAVE10_CDECL*)(OpaqueKeyedSet*, OpaqueWordVector*);
