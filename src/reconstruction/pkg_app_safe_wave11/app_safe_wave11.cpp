...
void PKG_APP_SAFE_WAVE11_THISCALL default_notify_0093db80(OpaquePropertyRecord*,
                                                          TargetByte) {}
...
default_reserve_00454b80(OpaqueWordVector* vector, TargetWord count) {
...
void PKG_APP_SAFE_WAVE11_THISCALL
default_pair_reserve_00454640(OpaqueAssocBlob*, TargetWord) {}
...
OpaqueTreeBlob* PKG_APP_SAFE_WAVE11_THISCALL default_tree_insert_004544d0(
    OpaqueTreeBlob* tree, const TargetWord*, const OpaqueWordPair*) {
  return tree;
}

void PKG_APP_SAFE_WAVE11_THISCALL
default_node_append_005402c0(OpaqueTreeBlob*) {}

void PKG_APP_SAFE_WAVE11_FASTCALL default_release_004c0b80(OpaqueWordVector*) {}

TargetWord PKG_APP_SAFE_WAVE11_CDECL default_array_bool_006a0760(
...
TargetWord PKG_APP_SAFE_WAVE11_CDECL default_global_key_015d(void) {
  return 0u;
}

TargetWord PKG_APP_SAFE_WAVE11_CDECL default_allocate_0042dee0(TargetWord,
                                                               TargetWord,
                                                               TargetWord,
                                                               TargetWord) {
  return 0u;
...
void PKG_APP_SAFE_WAVE11_CDECL default_release_00f47380(TargetWord) {}

void PKG_APP_SAFE_WAVE11_THISCALL default_push_004b7290(OpaquePairVector*,
                                                        TargetWord, TargetWord,
                                                        TargetByte) {}

TargetWord PKG_APP_SAFE_WAVE11_CDECL
default_stream_lookup_004c0500(TargetWord) {
  return 0u;
}

TargetWord PKG_APP_SAFE_WAVE11_CDECL default_stream_read_004bf430(TargetWord,
                                                                  TargetWord) {
  return 0u;
}

TargetByte PKG_APP_SAFE_WAVE11_CDECL default_stream_apply_004bc6d0(TargetWord,
                                                                   TargetWord,
                                                                   TargetWord) {
  return 0u;
}
...
TargetWord PKG_APP_SAFE_WAVE11_CDECL
default_stream_report_006ac0a0(TargetWord, TargetWord) {
  return 0u;
}
...
void PKG_APP_SAFE_WAVE11_THISCALL model_parts_apply_properties_00447150(
...
void PKG_APP_SAFE_WAVE11_THISCALL pair_vector_insert_004786e0(
...
OpaquePairVector* PKG_APP_SAFE_WAVE11_THISCALL pair_vector_construct_004b62a0(
...
TargetByte PKG_APP_SAFE_WAVE11_THISCALL stream_probe_dispatch_004bc540(
