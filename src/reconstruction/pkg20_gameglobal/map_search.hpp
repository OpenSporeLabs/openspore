...
static_assert(offsetof(OrderedMapEntry, key) == 0x10, "PKG-20 node key offset");
...
static_assert(offsetof(OrderedMap, anchor) == 0x04, "PKG-20 map anchor offset");
...
void PKG20_THISCALL pkg20_gameglobal_00e5c780(OrderedMap* map,
                                              OrderedMapEntry** result,
