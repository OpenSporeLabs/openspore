...
using PageSignature = void(PKG_PALETTE_SAFE_TEST_THISCALL*)(OpaquePage*, Word);
using PaletteSignature = void(PKG_PALETTE_SAFE_TEST_THISCALL*)(OpaquePalette*);
...
static_assert(std::is_same<decltype(&unresolved_0041e050),
                           void(PKG_PALETTE_SAFE_TEST_CDECL*)(
                               OpaqueTextBuffer*, const TextUnit*, std::int32_t,
                               std::int32_t)>::value,
...
static_assert(
    std::is_same<
        decltype(&unresolved_008105b0),
        OpaqueFeature*(PKG_PALETTE_SAFE_TEST_THISCALL*)(OpaqueFeatureHost*,
                                                        Word, Word)>::value,
