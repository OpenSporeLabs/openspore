...
#error "app services safe wave11 reconstruction requires an x86-32 target"
#endif
...
static_assert(sizeof(void*) == 4,
              "app services safe wave11 pointers are 32-bit");
static_assert(sizeof(std::uint32_t) == 4,
              "app services safe wave11 words are 32-bit");
static_assert(sizeof(std::uint16_t) == 2,
              "app services safe wave11 halves are 16-bit");
...
struct OpaqueGlobalVTable {
  void* slots_00[3]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_0c)(
      OpaqueGlobal*, void*, void*, OpaqueWord, OpaqueWord, OpaqueWord,
      OpaqueWord) = nullptr;
  void* slots_10[1]{};
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_14)(OpaqueGlobal*,
                                                       OpaqueWord,
                                                       OpaqueWord) = nullptr;
  void* slots_18[2]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_20)(
      OpaqueGlobal*, OpaqueWord, OpaqueWord, OpaqueWord, OpaqueWord,
      OpaqueWord) = nullptr;
  void* slots_24[4]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_34)(
      OpaqueGlobal*, void*, void*, OpaqueWord, OpaqueWord, OpaqueWord,
      OpaqueWord) = nullptr;
  void* slots_38[4]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_48)(
      OpaqueGlobal*, void*, OpaqueWord) = nullptr;
  void* slots_4c[8]{};
  OpaqueWord(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_6c)(
      OpaqueGlobal*, OpaqueWord, OpaqueWord) = nullptr;
};

struct OpaqueHandleVTable {
  void* slots_00[1]{};
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_04)(OpaqueHandle*) = nullptr;
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_08)(OpaqueHandle*) = nullptr;
  OpaqueWord(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_0c)(
      OpaqueHandle*, OpaqueWord) = nullptr;
};

struct OpaqueDatabaseVTable {
  void* slots_00[13]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_34)(
      OpaqueDatabase*, void*, void*, OpaqueWord, OpaqueWord, OpaqueWord,
      OpaqueWord) = nullptr;
};

struct OpaqueFactoryVTable {
  void* slots_00[7]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_1c)(
      OpaqueFactory*, void*, void*, OpaqueWord, OpaqueWord) = nullptr;
  void* slots_20[10]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_48)(
      OpaqueFactory*, OpaqueWord) = nullptr;
  void* slots_4c[3]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_58)(OpaqueFactory*,
                                                             void*) = nullptr;
};

struct OpaqueOwnerVTable {
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_00)(OpaqueOwner*) = nullptr;
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_04)(OpaqueOwner*) = nullptr;
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_08)(OpaqueOwner*) = nullptr;
  void* slots_0c[3]{};
  OpaqueWord(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_18)(
      OpaqueOwner*, OpaqueWord) = nullptr;
  void* slots_1c[2]{};
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_24)(OpaqueOwner*) = nullptr;
};

struct OpaqueSideVTable {
  void* slots_00[2]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_08)(
      OpaqueSide*, void*, void*, OpaqueWord) = nullptr;
};

struct OpaqueGateVTable {
  void* slots_00[7]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_1c)(OpaqueGate*,
                                                             OpaqueWord, void*,
                                                             OpaqueWord,
                                                             void*) = nullptr;
  void* slots_20[5]{};
  OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* slot_34)(
      OpaqueGate*, void*, void*, OpaqueWord, OpaqueWord, OpaqueWord,
      OpaqueWord) = nullptr;
};
...
struct Ports005f9230 {
  using Assign = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      OpaqueWide*, const OpaqueWideField*);
  using Copy = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueWide*, void*,
                                                            void*);
...
struct Ports005f9310 {
  using Resolve = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueWide*,
                                                               OpaqueWord,
                                                               OpaqueWord,
                                                               const void*);
  using Prepare = void(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(OpaqueWord,
                                                            OpaqueWide*,
                                                            OpaqueWord);
  using Append = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueWide*,
                                                              const void*,
                                                              const void*);
  using Emit = const void*(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueWide*);
  using Truncate = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueWide*,
                                                                OpaqueWord,
                                                                OpaqueWord,
                                                                const void*);
  using Finalize = OpaqueByte(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(const void*);
  using Destroy = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueWide*);
...
struct Ports005fa8d0 {
  using Prepare = OpaqueWord*(
      PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueEncoder70*, OpaqueHalf,
                                              OpaqueHalf, OpaqueByte,
                                              OpaqueWord);
  using Fill = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, void*,
                                                                  OpaqueWord,
                                                                  OpaqueWord);
  using Global = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)();
  using Resolve = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      OpaqueService*, OpaqueWord, OpaqueWord, OpaqueWord);
  using Write =
      OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueService*, void*);
  using Compose = OpaqueWord*(
      PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueWord, void*, void*,
                                              OpaqueWord, OpaqueWord);
  using Slot = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, void*);
  using OpenQuery = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      void*, OpaqueWord, OpaqueWord, OpaqueWord, OpaqueWord);
  using Emit = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueEncoder70*,
                                                            OpaqueWord);
  using EmitPair = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      OpaqueEncoder70*, void*, OpaqueWord);
  using Open = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*);
  using Destroy = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, void*);
  using Release = void(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(void*);
  using Build = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*,
                                                                    void*);
  using Store = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, void*);
  using Insert = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueBlock32*,
                                                              void*, void*);
  using Select = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*,
                                                                     void*,
                                                                     void*);
  using Record = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueBlock32*,
                                                              void*, void*);
  using Flush = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueService*);
  using Clear = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*);
...
struct Ports005fc330 {
  using Slot = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, void*);
  using Open = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*);
  using Query = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      void*, OpaqueWord, OpaqueWord, OpaqueWord, OpaqueWord);
  using Get = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)();
  using Probe = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      OpaqueService*, void*, void*, void*);
  using Reset = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueBlock32*,
                                                             void*, void*);
  using Resolve = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*,
                                                                     OpaqueWord,
                                                                     OpaqueWord,
                                                                     void*);
  using Mark = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, OpaqueWord,
                                                            OpaqueWord,
                                                            OpaqueWord);
  using Lift = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, OpaqueWord,
                                                            void*, void*);
  using BuildC = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(OpaqueWord);
  using Factory = OpaqueWord*(
      PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(OpaqueWord, OpaqueWord, OpaqueWord,
                                           OpaqueWord, OpaqueWord, OpaqueWord);
  using Build = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*);
  using Meta = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      void*, void*, void*, void*, void*, void*, void*, void*, void*, OpaqueWord,
      OpaqueWord, OpaqueWord, OpaqueWord, OpaqueWord);
  using Meta2 = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, OpaqueWord,
                                                             OpaqueWord);
  using Flag = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, OpaqueWord);
  using NodeBuild = OpaqueWord*(
      PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, OpaqueWord, OpaqueWord,
                                              void*, OpaqueWord);
  using Release = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*);
  using ReleaseC = void(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(void*);
  using Toggle = void(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(void*, OpaqueWord);
  using SelectKey = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueBlock32*,
                                                                 OpaqueWord,
                                                                 void*, void*);
  using Emit = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueEncoder70*,
                                                            OpaqueWord);
  ...
  void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL* close_005f8e40)(void*) = nullptr;
  Open close_00931a70 = nullptr;
...
struct Ports0060ee90 {
  using Get = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)();
  using Global0c = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      void*, void*, void*, OpaqueWord, OpaqueWord, OpaqueWord, OpaqueWord);
  using Global20 = OpaqueBool(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      void*, OpaqueWord, OpaqueWord, OpaqueWord);
  using Global6c = OpaqueWord(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(
      void*, OpaqueWord, OpaqueWord);
  using Probe = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*);
  using Drop = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, OpaqueWord,
                                                            OpaqueWord);
  using Owner = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(void*);
  using Compose = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*);
  using Factory = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_CDECL*)(OpaqueWord);
  using Build = OpaqueWord*(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*,
                                                                    OpaqueWord,
                                                                    OpaqueWord,
                                                                    OpaqueWord,
                                                                    OpaqueWord,
                                                                    OpaqueWord);
  using Grow = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(void*, void*);
  using Place = void(PKG_APP_SERVICES_SAFE_WAVE11_THISCALL*)(OpaqueOwner60ee90*,
                                                             void*);
