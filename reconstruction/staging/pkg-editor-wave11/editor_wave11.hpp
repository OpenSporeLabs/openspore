...
#error "PKG-EDITOR-WAVE11 requires an x86-32 target"
#endif
...
static_assert(sizeof(void*) == 4, "W11 requires 32-bit pointers");
static_assert(sizeof(Word) == 4, "W11 requires 32-bit words");
static_assert(sizeof(Real) == 4, "W11 requires 32-bit floats");
...
inline constexpr Word kAcquireProfile = 0x00000a18u;
inline constexpr Word kNameProfile = 0x013f0e00u;
...
struct alignas(4) OpaqueNotifyTable {
  Byte opaque_00[0x28];
  void(W11_STDCALL* notify_028)(Word, Word);
};
...
struct alignas(4) OpaqueProbeTable {
  Byte opaque_00[0x38];
  bool(W11_STDCALL* slot_038)(const void*, Word);
};
...
struct alignas(4) OpaquePairRoot {
  Byte opaque_000[0x70];
  OpaqueHandle* first_070;
  OpaqueHandle* second_074;
  Byte opaque_078[8];
};

struct alignas(4) OpaqueSpeciesKey {
  Word word_00;
  Word word_04;
  Word word_08;
};

struct alignas(4) OpaqueLinkCell {
  Word slot_00;
  Word span_04;
  Word tag_08;
};

struct alignas(4) OpaqueLinkRoot {
  Byte opaque_000[4];
  OpaqueLinkCell* anchor_004;
  Byte opaque_008[0x9c];
  OpaqueSpeciesKey fallback_0a4;
};
...
static_assert(offsetof(OpaqueHandle, count_008) == 0x08, "handle count");
static_assert(offsetof(OpaquePairRoot, first_070) == 0x70, "pair first");
static_assert(offsetof(OpaquePairRoot, second_074) == 0x74, "pair second");
static_assert(offsetof(OpaqueLinkRoot, anchor_004) == 0x04, "link anchor");
static_assert(offsetof(OpaqueLinkRoot, fallback_0a4) == 0xa4, "link fallback");
static_assert(offsetof(OpaqueLinkCell, slot_00) == 0x00, "link slot");

extern Real g_real_013ef54c;

extern "C" void* W11_CDECL unresolved_00f473a0(Word, Word, Word, Word, Word,
                                               Word);
extern "C" bool W11_THISCALL unresolved_00526430(OpaqueWords3*);
extern "C" void W11_THISCALL unresolved_004b1cc0(void*, OpaqueWords3*, void*,
                                                 Byte);
extern "C" void W11_THISCALL unresolved_004aff80(void*, Signed);
extern "C" const OpaqueRecord* W11_THISCALL unresolved_0044ae00(void*,
                                                                OpaqueRecord*,
                                                                Word, Word,
                                                                Word);
extern "C" void W11_CDECL unresolved_0041dba0(void*, const Real*);
extern "C" void W11_THISCALL unresolved_00409930(OpaqueBox*);
extern "C" void W11_THISCALL unresolved_00409dd0(OpaqueRecord*,
                                                 const OpaqueBox*);
extern "C" bool W11_CDECL unresolved_004bf0a0(void*, void*, Word);
extern "C" bool W11_THISCALL unresolved_004ccae0(void*, OpaqueFloats3,
                                                 OpaqueFloats3, OpaqueWords3*,
                                                 OpaqueWords3*, Real*, Word);
extern "C" bool W11_CDECL unresolved_004da3a0(OpaqueSpeciesKey*);
extern "C" Word W11_STDCALL unresolved_004df6d0(void*, const OpaqueSpeciesKey*);
extern "C" OpaqueLinkCell* W11_THISCALL
unresolved_004e0560(OpaqueLinkCell*, const OpaqueSpeciesKey*);
extern "C" Word W11_THISCALL unresolved_004d3dd0(void*, OpaqueSpeciesKey*,
                                                 Word);

extern "C" bool W11_THISCALL editor_paint_commit_0043ac40(OpaquePaintState*,
                                                          Word, Word, Byte);
extern "C" void W11_THISCALL editor_entry_expand_004ad6f0(OpaqueEntryList*,
                                                          OpaqueRecord*);
extern "C" bool W11_CDECL editor_bake_probe_004bf770(OpaqueProbeOwner*,
                                                     OpaqueBakeRow*);
extern "C" bool W11_THISCALL editor_bake_select_004c4a30(OpaqueBakeRoot*,
                                                         Signed, Real, Real,
                                                         Real, Real, Real, Real,
                                                         Word*, Word*, Real*,
                                                         Byte);
extern "C" void W11_THISCALL editor_pair_retain_004c5910(OpaquePairRoot*,
                                                         OpaqueHandle**,
                                                         OpaqueHandle**);
extern "C" Word W11_THISCALL
editor_species_resolve_004df550(OpaqueLinkRoot*, const OpaqueSpeciesKey*);
