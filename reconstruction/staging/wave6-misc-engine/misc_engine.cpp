...
TargetWord g_app_system_015fd890 = 0;
...
OpaqueIAppSystem* WAVE6_CDECL app_iapp_system_get_0067dcc0() {
  return target_pointer<OpaqueIAppSystem*>(g_app_system_015fd890);
}
