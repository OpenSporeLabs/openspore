...
struct TestHooks : OpaqueInputHooks {
  ...
  void selection_side_effect(OpaqueSelectionTarget*, TargetWord value) override {
...
void test_mouse_move() {
  ...
  assert(test_events->events[0].name == std::string("mode_move"));
}
...
void test_key_up() {
  ...
  assert(test_events->events[0].name == std::string("game_key_up"));
  assert(test_events->events[1].name == std::string("refresh"));
  assert(test_events->events[2].name == std::string("mode_key_up"));
  assert(test_events->events[3].name == std::string("refresh"));
}
...
void test_wheel() {
  ...
  assert(test_events->size() == 1);
  assert(test_events->events[0].name == std::string("wheel"));
  assert(test_events->events[0].first == 0x78u);
}
...
void test_mouse_down() {
  ...
  assert(test_events->events[0].name == std::string("mode_down"));
  assert(test_events->events[1].name == std::string("mouse_down_tail"));
}
...
void test_mouse_up() {
  ...
  assert(test_events->events[0].name == std::string("selection_up"));
  assert(test_events->events[1].name == std::string("selection_status"));
  assert(test_events->events[2].name == std::string("selection_side_effect"));
  assert(test_events->events[3].name == std::string("selection_finish"));
  assert(test_events->events[4].name == std::string("selection_release"));
  assert(test_events->events[5].name == std::string("mouse_up_cleanup"));
}
...
void test_key_down() {
  ...
  assert(test_events->size() == 4);
  assert(test_events->events[3].name == std::string("key_command"));
  assert(test_events->events[3].second == 0x13u);
