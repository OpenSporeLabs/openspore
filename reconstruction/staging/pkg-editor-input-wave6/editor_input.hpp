...
using ModeMouseDown = void(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueModeTarget*, TargetWord, float, float, TargetWord);
using ModeMouseUp = bool(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueModeTarget*, TargetWord, float, float, TargetWord);
using ModeMouseMove = void(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueModeTarget*, float, float, TargetWord);
using ModeKeyDown = bool(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueModeTarget*, TargetWord, TargetWord);
using ModeKeyUp = void(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueModeTarget*, TargetWord, TargetWord);
...
using SelectionRelease = void(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueSelectionTarget*);
using SelectionMouseUp = bool(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueSelectionTarget*, TargetWord, float, float, TargetWord);
using SelectionMove = bool(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueSelectionTarget*, float, float, TargetWord);
using SelectionQuery = TargetWord(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueSelectionTarget*);
using SelectionFinish = void(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueSelectionTarget*);
using SelectionStatus = bool(PKG_EDITOR_INPUT_THISCALL*)(
    OpaqueSelectionTarget*);
