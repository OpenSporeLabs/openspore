...
static_assert(sizeof(void *) == 4,
              "pkg-skinner-wave11 requires 32-bit pointers");
static_assert(sizeof(float) == 4, "pkg-skinner-wave11 requires 32-bit floats");
static_assert(sizeof(bool) == 1, "pkg-skinner-wave11 requires one-byte bools");
static_assert(sizeof(short) == 2,
              "pkg-skinner-wave11 requires 16-bit rigblock flags");
...
struct OpaqueGraphicsProbeVTable {
  void *slots_000[17];
  TargetWord(PKG_SKINNER_WAVE11_THISCALL *query_044)(OpaqueGraphicsProbe *);
};
...
using GraphicsQuery =
    TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueGraphicsProbe *);

using CreateFromBlock = OpaqueRefObject *(
    PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRenderTargetManager *,
...
using CanCreate = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(
    OpaqueRenderTargetManager *, OpaqueKeyBlock block);

using Prepare = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(
...
using HasBlock = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueElement *,
                                                           TargetWord key);

using GetBlock = OpaqueRefObject *(
    PKG_SKINNER_WAVE11_THISCALL *)(OpaqueElement *, TargetWord key);

struct OpaqueElementVTable {
  void *slots_000[7];
  HasBlock has_01c;
  void *slots_020[2];
  GetBlock get_028;
...
struct OpaqueElement {
  OpaqueElementVTable *vtable_000;
  std::uint8_t opaque_004[0xc];
  TargetWord field_010;
  TargetWord field_014;
  TargetWord field_018;
  TargetWord field_01c;
  ...
  TargetWord field_060;
  TargetWord field_064;
  std::uint8_t opaque_068[0x10];
  TargetWord field_078;
  TargetWord field_07c;
};

using RefAddRef = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *);
using RefRelease = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *);
using RefStep = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *);
...
using RenderDispatch = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(
...
struct OpaqueSlotHandle {
  TargetWord field_000;
  TargetWord field_004;
};

struct OpaqueCursorQuad {
  TargetWord field_000;
  TargetWord field_004;
  TargetWord field_008;
  TargetWord field_00c;
...
using GetPaintSystem = OpaquePaintSystem *(PKG_SKINNER_WAVE11_CDECL *)();
using GetGraphicsProbe = OpaqueGraphicsProbe *(PKG_SKINNER_WAVE11_CDECL *)();
using GetRenderTargetManager =
    OpaqueRenderTargetManager *(PKG_SKINNER_WAVE11_CDECL *)();
using GetRenderObject = OpaqueRefObject *(PKG_SKINNER_WAVE11_CDECL *)();
using GetDefaultDesc = const OpaqueKeyBlock *(PKG_SKINNER_WAVE11_CDECL *)();
using GetScale = float(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *,
                                                      TargetWord key);
using Classify = TargetWord(PKG_SKINNER_WAVE11_CDECL *)(TargetWord id);
using GetFloat = bool(PKG_SKINNER_WAVE11_CDECL *)(TargetWord object,
                                                  TargetWord key, float *out);
using GetKey = bool(PKG_SKINNER_WAVE11_CDECL *)(TargetWord id, TargetWord key,
                                                OpaqueKeyBlock *out);
using AcquireObject = void *(PKG_SKINNER_WAVE11_CDECL *)(TargetWord size,
                                                         TargetWord key,
                                                         TargetWord arg_2,
                                                         TargetWord arg_3,
                                                         TargetWord arg_4,
...
using StartRender = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueTexturePainter *);
using SetColorWrite = void(PKG_SKINNER_WAVE11_THISCALL *)(
    OpaqueTexturePainter *, TargetWord a0, TargetWord a1, TargetWord a2,
    TargetWord a3);
using PaintRegion = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueTexturePainter *,
                                                        const OpaqueVec2 *a0,
                                                        const OpaqueVec2 *a1,
                                                        TargetWord a2);
using EndRender = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueTexturePainter *);
using EmitVertex = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueTexturePainter *,
                                                       const OpaqueVec2 *pos,
                                                       const OpaqueVec2 *uv,
                                                       const OpaqueVec3w *nrm,
                                                       TargetWord colour);
using SetVertexLimit = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(
    OpaqueTexturePainter *, TargetWord requested);
using FlushBatch = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueTexturePainter *);
using CopyVec3 = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueVec3f *out,
                                                     const OpaqueVec3f *in);
using GetRaster =
    OpaqueRefObject *(PKG_SKINNER_WAVE11_THISCALL *)(OpaquePaintSystem *);
using GetDesc =
    const OpaqueKeyBlock *(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *);
using AcquireSlot = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueSlotHandle *);
using Collect = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueVector *,
                                                    OpaqueRefObject **slot);
using Rewind = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueVector *);
using ReleaseOne = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *);
using Truncate = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueVector *,
                                                     OpaqueRefObject *begin,
                                                     OpaqueRefObject *end);
using LazyReset = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject **);
using JobInit = void(PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *);
using JobInitPrimary = TargetWord(PKG_SKINNER_WAVE11_THISCALL *)(
    OpaqueRefObject *, TargetWord owner, TargetByte flag);
using JobBuild = OpaqueRefObject *(
    PKG_SKINNER_WAVE11_THISCALL *)(OpaqueRefObject *, TargetWord a0,
                                   TargetWord a1, TargetWord a2, TargetByte a3,
                                   TargetWord a4, TargetByte a5, TargetByte a6);
using SwapPairs = void(PKG_SKINNER_WAVE11_THISCALL *)(void *, void *);
using ResolveRefVTable =
    OpaqueRefVTable *(PKG_SKINNER_WAVE11_CDECL *)(TargetWord address);

struct SkinnerWave11Ports {
  ...
  CopyVec3 copy_vec3_004098a0;
  Classify classify_004bb860;
  GetFloat get_float_0040cf10;
  GetKey get_key_006a1250;
  GetDesc get_desc_00446ff0;
  GetDefaultDesc get_default_desc_006bb640;
  AcquireObject acquire_object_00f473a0;
  GetRaster get_raster_00525aa0;
  AcquireSlot acquire_slot_00552750;
  Collect collect_0051d1e0;
  Rewind rewind_0051d140;
  ReleaseOne release_one_00402420;
  Truncate truncate_004259e0;
  LazyReset lazy_reset_0041d870;
  JobInit job_init_005173a0;
  JobInitPrimary job_init_primary_00517310;
  JobBuild job_build_0051c470;
  ResolveRefVTable resolve_ref_vtable;
};

extern SkinnerWave11Ports g_skinner_wave11_ports;

extern float g_skinner_wave11_scale[9];
extern OpaqueRefObject *g_skinner_wave11_scale_source;
...
static_assert(offsetof(OpaqueElementVTable, has_01c) == 0x1c,
              "element has-block slot offset");
static_assert(offsetof(OpaqueElementVTable, get_028) == 0x28,
              "element get-block slot offset");
...
#undef PKG_SKINNER_WAVE11_CDECL
