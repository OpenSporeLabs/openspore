...
#include "app_services_wave11.hpp"

#if defined(_MSC_VER)
#define PKG_T_CDECL __cdecl
#define PKG_T_THISCALL __thiscall
#define PKG_T_NOINLINE __declspec(noinline)
#else
#define PKG_T_CDECL __attribute__((cdecl))
#define PKG_T_THISCALL __attribute__((thiscall))
#define PKG_T_NOINLINE __attribute__((noinline))
#endif

namespace {

using namespace openspore::reconstruction::pkg_app_services_wave11;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_assign(OpaqueWide *dst,
                                               const OpaqueWideField *src) {
  ++g_assign_calls;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_copy(OpaqueWide *dst, void *begin,
                                             void *end) {
  ++g_copy_calls;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_resolve(OpaqueWide *dst,
                                                OpaqueWord table,
                                                OpaqueWord instance,
                                                const void *literal) {
  g_table_id = table;
...
PKG_T_CDECL void PKG_T_NOINLINE stub_prepare(OpaqueWord key, OpaqueWide *dst,
                                             OpaqueWord flag) {
  g_prepare_key = key;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_append(OpaqueWide *dst,
                                               const void *begin,
                                               const void *end) {
  (void)dst;
  ++g_append_calls;
...
PKG_T_THISCALL const void *PKG_T_NOINLINE stub_emit(OpaqueWide *scratch) {
  (void)scratch;
  ++g_9310_emit_calls;
  note("emit");
  return payload.data();
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_truncate(OpaqueWide *dst,
                                                 OpaqueWord index,
                                                 OpaqueWord count,
                                                 const void *fill) {
  (void)dst;
...
PKG_T_CDECL OpaqueByte PKG_T_NOINLINE stub_finalize(const void *input) {
  g_finalize_input = as_word(input);
  note("finalize");
  return static_cast<OpaqueByte>(g_finalize_result);
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_destroy(OpaqueWide *scratch) {
  (void)scratch;
  ++g_destroy_calls;
  note("destroy");
}
...
void test_005f9310() {
  ...
  auto wide_end = [](OpaqueWord *begin, std::size_t units) {
    return reinterpret_cast<OpaqueWord *>(
        reinterpret_cast<OpaqueByte *>(begin) + units * 2u);
  };
...
PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_fill(void *receiver, void *buffer,
                                                   OpaqueWord size,
                                                   OpaqueWord mip) {
  (void)buffer;
...
PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_global_a() {
  note("global");
  return reinterpret_cast<OpaqueWord *>(static_cast<void *>(&g_a8d0_global));
}

PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_global_slot_0c(
    OpaqueGlobal *self, void *first, void *second, OpaqueWord third,
    OpaqueWord fourth, OpaqueWord fifth, OpaqueWord sixth) {
  (void)self;
  (void)third;
  (void)fourth;
  (void)fifth;
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_resolve2(OpaqueService *self,
                                                       OpaqueWord first,
                                                       OpaqueWord second,
                                                       OpaqueWord third) {
  (void)self;
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_database_slot_34(
    OpaqueDatabase *self, void *first, void *second, OpaqueWord a3,
...
PKG_T_THISCALL OpaqueWord PKG_T_NOINLINE stub_owner_slot_18(OpaqueOwner *self,
                                                            OpaqueWord flag) {
  (void)self;
  (void)flag;
  note("owner_18");
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_owner_slot_24(OpaqueOwner *self) {
  (void)self;
  ++g_owner_release;
  note("owner_24");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_emit_encoder(OpaqueEncoder70 *receiver,
                                                     OpaqueWord value) {
  (void)receiver;
  ++g_emit_calls;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_emit_pair(OpaqueEncoder70 *receiver,
                                                  void *first,
                                                  OpaqueWord second) {
  (void)receiver;
  (void)first;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_handle_04(OpaqueHandle *self) {
  (void)self;
  ++g_handle_releases;
  note("handle_04");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_handle_08(OpaqueHandle *self) {
  (void)self;
  ++g_handle_releases;
  note("handle_08");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_owner_slot_08(OpaqueOwner *self) {
  (void)self;
  ++g_handle_releases;
  note("owner_08");
}

PKG_T_THISCALL OpaqueWord PKG_T_NOINLINE stub_handle_0c(OpaqueHandle *self,
                                                        OpaqueWord tag) {
  (void)self;
...
PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE stub_compose(OpaqueWord receiver,
                                                       void *first,
                                                       void *second,
                                                       OpaqueWord a3,
                                                       OpaqueWord a4) {
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_write(OpaqueService *self,
                                                    void *handle) {
  (void)self;
  (void)handle;
  note("write");
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_slot(void *receiver, void *source) {
  (void)receiver;
  (void)source;
  note("slot");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_open_slot(void *receiver) {
  (void)receiver;
  note("open_slot");
}

PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_open_query(void *receiver,
                                                         OpaqueWord a1,
                                                         OpaqueWord a2,
                                                         OpaqueWord a3,
                                                         OpaqueWord a4) {
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_destroy(void *receiver, void *source) {
  (void)receiver;
  (void)source;
  note("destroy");
}

PKG_T_CDECL void PKG_T_NOINLINE stub_release(void *receiver) {
  (void)receiver;
  note("release");
}

PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE stub_build(void *receiver,
                                                     void *source) {
  (void)receiver;
  (void)source;
  note("build");
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_store(void *receiver, void *value) {
  (void)receiver;
  (void)value;
  note("store");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_insert(OpaqueBlock32 *block,
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_clear(void *receiver) {
  (void)receiver;
  note("clear");
}

PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE stub_select(void *receiver,
                                                      void *first,
                                                      void *second) {
  (void)receiver;
  (void)first;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_record(OpaqueBlock32 *block,
                                               void *first, void *second) {
  (void)first;
  (void)second;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_flush(OpaqueService *self) {
  (void)self;
  note("flush");
}
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_slot(void *receiver, void *source) {
  (void)receiver;
  (void)source;
  note("push");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_open(void *receiver) {
  (void)receiver;
  note("state");
}

PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_c_query(void *receiver,
                                                      OpaqueWord a1,
                                                      OpaqueWord a2,
                                                      OpaqueWord a3,
                                                      OpaqueWord a4) {
...
PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_c_get() {
  note("get");
  return g_c_allocator;
}

PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_c_probe(OpaqueService *self,
                                                      void *first, void *second,
                                                      void *third) {
  (void)self;
  (void)first;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_reset(OpaqueBlock32 *block,
                                                void *first, void *second) {
  (void)second;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_close_raster(void *receiver) {
  (void)receiver;
  ++g_close_raster;
  note("close_raster");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_close_stream(void *receiver) {
  (void)receiver;
  ++g_close_stream;
  note("close_stream");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_close_slot(void *receiver) {
  (void)receiver;
  note("close_slot");
}

PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_c_resolve(void *receiver,
                                                        OpaqueWord a1,
                                                        OpaqueWord a2,
                                                        void *third) {
  (void)receiver;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_mark(void *receiver, OpaqueWord a1,
                                               OpaqueWord a2, OpaqueWord a3) {
  (void)receiver;
  (void)a1;
  (void)a2;
  (void)a3;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_lift(void *receiver, OpaqueWord a1,
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_c_cast(OpaqueFactory *self,
                                                     void *out) {
  (void)self;
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_c_side(OpaqueSide *self,
                                                     void *first, void *second,
                                                     OpaqueWord third) {
  (void)self;
  (void)second;
...
PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE
...
PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE stub_c_build_meta(void *receiver) {
  (void)receiver;
  note("build_meta");
  return reinterpret_cast<OpaqueWord *>(&g_c_owner);
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_meta(void *receiver, void *a1,
                                               void *a2, void *a3, void *a4,
                                               void *a5, void *a6, void *a7,
                                               void *a8, OpaqueWord a9,
                                               OpaqueWord a10, OpaqueWord a11,
                                               OpaqueWord a12, OpaqueWord a13) {
  (void)receiver;
  (void)a1;
  (void)a2;
  (void)a3;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_seal(void *receiver, OpaqueWord a1,
                                               OpaqueWord a2) {
  (void)receiver;
  (void)a1;
  (void)a2;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_flag(void *receiver,
                                               OpaqueWord flag) {
  (void)receiver;
  note_arg("flag", flag);
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_drop(void *receiver,
                                               OpaqueWord value) {
  (void)receiver;
  note_arg("drop", value);
}

PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_c_resource(OpaqueWord tag) {
  note_arg("resource", tag);
  return reinterpret_cast<OpaqueWord *>(&g_c_gate);
}

PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_c_global() {
  note("global");
  return reinterpret_cast<OpaqueWord *>(&g_c_global);
}

PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_c_side_get() {
  note("side_get");
  return reinterpret_cast<OpaqueWord *>(&g_c_side);
}

PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_c_global_48(OpaqueGlobal *self,
                                                          void *a1,
                                                          OpaqueWord a2) {
  (void)self;
  (void)a2;
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_global_14(OpaqueGlobal *self,
                                                    OpaqueWord a1,
                                                    OpaqueWord a2) {
  (void)self;
  (void)a2;
...
PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_c_node(OpaqueWord a1, OpaqueWord a2,
                                                   OpaqueWord a3, OpaqueWord a4,
                                                   OpaqueWord a5,
                                                   OpaqueWord a6) {
  (void)a2;
  (void)a3;
...
PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE stub_c_node_build(
    void *receiver, OpaqueWord a1, OpaqueWord a2, void *a3, OpaqueWord a4) {
  (void)receiver;
  (void)a1;
  (void)a2;
  (void)a4;
...
PKG_T_CDECL void PKG_T_NOINLINE stub_c_toggle_one(void *a1) {
  (void)a1;
  note("toggle_one");
}

PKG_T_CDECL void PKG_T_NOINLINE stub_c_toggle(void *a1, OpaqueWord a2) {
  (void)a1;
  note_arg("toggle", a2);
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_record(OpaqueBlock32 *block,
                                                 OpaqueWord a1, void *a2,
                                                 void *a3) {
  (void)a1;
  (void)a2;
  (void)a3;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_emit(OpaqueEncoder70 *receiver,
                                               OpaqueWord value) {
  (void)receiver;
  note_arg("emit", value);
}

PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_c_gate_1c(OpaqueGate *self,
                                                        OpaqueWord a1, void *a2,
                                                        OpaqueWord a3,
                                                        void *a4) {
  (void)self;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_owner_00(OpaqueOwner *self) {
  (void)self;
  note("owner_00");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_owner_04(OpaqueOwner *self) {
  (void)self;
  note("owner_04");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_owner_08(OpaqueOwner *self) {
  (void)self;
  note("owner_08");
}

PKG_T_THISCALL OpaqueWord PKG_T_NOINLINE stub_c_owner_18(OpaqueOwner *self,
                                                         OpaqueWord flag) {
  (void)self;
  (void)flag;
  note("owner_18");
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_c_owner_24(OpaqueOwner *self) {
  (void)self;
  note("owner_24");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_handle_04(OpaqueHandle *self) {
  (void)self;
  note("handle_04");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_c_handle_08(OpaqueHandle *self) {
  (void)self;
  note("handle_08");
}
...
PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_e_global() {
  note("global");
...
PKG_T_THISCALL OpaqueBool PKG_T_NOINLINE stub_e_global_20(void *self,
                                                          OpaqueWord a1,
                                                          OpaqueWord a2,
                                                          OpaqueWord a3) {
  (void)self;
...
PKG_T_THISCALL OpaqueWord PKG_T_NOINLINE stub_e_global_6c(void *self,
                                                          OpaqueWord a1,
                                                          OpaqueWord a2) {
  (void)self;
  (void)a1;
...
PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE stub_e_probe(void *self) {
  (void)self;
  note("probe");
  return g_owner_pair;
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_e_drop(void *self, OpaqueWord a1,
                                               OpaqueWord a2) {
  (void)self;
  g_owner_drop[0] = a1;
  g_owner_drop[1] = a2;
...
PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_e_owner(void *key) {
  (void)key;
  note("owner");
  return reinterpret_cast<OpaqueWord *>(&g_e_owner);
}

PKG_T_THISCALL OpaqueWord *PKG_T_NOINLINE stub_e_compose(void *self) {
  (void)self;
  note("compose");
  return reinterpret_cast<OpaqueWord *>(&g_e_owner);
}

PKG_T_CDECL OpaqueWord *PKG_T_NOINLINE stub_e_factory(OpaqueWord size) {
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_e_grow(void *self, void *value) {
  (void)self;
  (void)value;
  ++g_owner_grow;
  note("grow");
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_e_place(OpaqueOwner60ee90 *self,
                                                void *key) {
  (void)self;
...
PKG_T_THISCALL void PKG_T_NOINLINE stub_e_slot_04(OpaqueOwner *self) {
  (void)self;
  ++g_owner_retain;
  note("slot_04");
}

PKG_T_THISCALL void PKG_T_NOINLINE stub_e_slot_08(OpaqueOwner *self) {
  (void)self;
...
int main() {
  ...
  test_005fc330();
  test_0060ee90();
  std::printf("wave11 model: checks=%d failures=%d\n", checks, failures);
