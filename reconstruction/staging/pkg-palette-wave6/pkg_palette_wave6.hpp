...
static_assert(sizeof(void*) == 4, "PKG-PALETTE-WAVE6 target pointers are 32-bit");
static_assert(sizeof(std::uint32_t) == 4, "PKG-PALETTE-WAVE6 target words are 32-bit");
...
static_assert(sizeof(OpaqueViewerObject) == 0x18,
              "opaque viewer object size");
...
static_assert(sizeof(OpaqueViewerItem) == 0x34,
              "viewer item size");
...
static_assert(sizeof(OpaqueAdvancedItemViewer) == 0x1c8,
              "viewer object size");

namespace openspore::reconstruction::pkg_palette_wave6 {

using ViewerItemSlot08 = std::uint8_t(PKG_PALETTE_THISCALL *)(
    OpaqueViewerObject*, void*);
...
using ViewerObjectSlot28 = void(PKG_PALETTE_THISCALL *)(
    OpaqueViewerObject*, OpaqueViewerItem*, void*, OpaqueViewerObject*);
using ViewerSlot34 = OpaqueRenderTarget*(PKG_PALETTE_THISCALL *)(
    OpaqueAdvancedItemViewer*, std::uint32_t, std::uint32_t);
using GraphicsSlot04 = OpaqueGraphicsContext*(PKG_PALETTE_THISCALL *)(
    OpaqueGraphicsRoot*);
using GraphicsSlot34 = OpaqueRect*(PKG_PALETTE_THISCALL *)(
    OpaqueGraphicsContext*);
using AppSlot14 = void(PKG_PALETTE_THISCALL *)(
    OpaqueAppSystem*, std::uint32_t, OpaqueCommandLine*, std::uint32_t);

extern "C" {

OpaquePaletteMain* PKG_PALETTE_THISCALL pkg_palette_005c5ee0(
    OpaquePaletteMain*, std::uint32_t);
OpaquePalettePage* PKG_PALETTE_THISCALL pkg_palette_005c8bc0(
    OpaquePalettePage*, std::uint32_t);
void PKG_PALETTE_THISCALL pkg_palette_005f4750(
    OpaqueAdvancedItemViewer*);
...
OpaqueSwatchState* PKG_PALETTE_THISCALL unresolved_0113ae10(
    OpaqueSwatchManager*);

OpaqueViewerObject* PKG_PALETTE_CDECL unresolved_00f473a0(
...
void PKG_PALETTE_THISCALL unresolved_005ed320(OpaqueSwatchManager*,
                                                std::uint32_t);
void PKG_PALETTE_THISCALL unresolved_005ee480(
    OpaqueSwatchManager*, OpaqueViewerObject*, OpaqueViewerItem*,
    OpaqueViewerObject*, std::uint32_t);
OpaqueGraphicsRoot* PKG_PALETTE_CDECL unresolved_0067caa0();
OpaqueRenderTarget* PKG_PALETTE_CDECL unresolved_0067cad0();
void PKG_PALETTE_STDCALL unresolved_0080d710(OpaqueRenderTarget*,
                                               std::uint32_t,
                                               std::uint8_t);
