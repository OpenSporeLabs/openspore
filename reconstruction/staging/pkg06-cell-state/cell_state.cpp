...
static_assert(sizeof(CellDirectionVector) == 12,
              "CellDirectionVector must preserve its observed width");
...
static_assert(sizeof(void *) == 4,
              "PKG-06 staging requires 32-bit pointers");
...
struct MachineAbiAdapters {
  ...
  static u32 e8105b0_ecx_ret8(u32 ecx_receiver, u32 stack_hash,
                               u32 stack_mode);
  ...
  static void e78b80_ecx_edx_hidden_edi_stack(
      const float *ecx_query, u32 edx_pool, float stack_query,
...
u32 opaque_00e51ee0(u32 event_kind, float initial_time, u32 target_index,
                    ...
                    float field_40, const CellDirectionVector *direction,
...
u8 opaque_00e59010(u32 target_index, u32 source_index, u32 effect_kind,
                    ...
                    const CellDirectionVector *direction);
...
extern "C" std::uint8_t cell_state_apply_damage_00e7a7c0(
    ...
    const CellDirectionVector *direction, std::uint32_t damage_kind,
